...
def search_users(email,display_name):
    ...
    users_list = list_users (email,display_name,access_token)    
    return users_list


def list_users(email,display_name,access_token):
    users_list = []
    ...
    req_params = {'$select': 'id,surname,givenName,companyName,mail,externalUserState,extension_9026d427583e4950bf6071088d21aefd_ILERPT_Session_UserID,extension_fe10b6b46b9f4cb68747ccf08f83782a_ILE_Alternate_UserID_1', '$filter': filter}
    print(req_params)
