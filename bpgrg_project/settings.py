"""
Django settings for bpgrg_project project.
...
ROOT_URLCONF = 'bpgrg_project.urls'
...
WSGI_APPLICATION = 'bpgrg_project.wsgi.application'
...
STATICFILES_DIRS = [os.path.join(BASE_DIR,'bpgrg/static')]
